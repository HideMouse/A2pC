...
- Q: 你为什么要做这个编译器？(Why do you make this compiler?) \
  A: 闲的没事。(Nothing to do.)
- Q: 我该咋在本地构建这个编译器？(How can I build this compiler?) \
  A: 下载，直接在CMD或PowerShell里输入```.\make```就行。(Download source code, then run ```.\make``` in CMD or PowerShell.)